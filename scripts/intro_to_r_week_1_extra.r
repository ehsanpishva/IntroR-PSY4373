...
# note: it is possible to read in SPSS, Excel, etc. files directly, but we
# will not get into this for now; see the R Data Import/Export manual:
...
# large datasets are more easily inspected with View()
